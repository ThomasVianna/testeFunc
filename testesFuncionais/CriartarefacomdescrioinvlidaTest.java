...
import java.net.URL;
public class CriartarefacomdescrioinvlidaTest {
  ...
  @Test
  public void criartarefacomdescrioinvlida() {
    ...
    driver.findElement(By.id("cpNome")).sendKeys("trabalhar na fabrica");
    driver.findElement(By.id("cpData")).click();
    driver.findElement(By.id("cpData")).sendKeys("2024-11-05");
    driver.findElement(By.cssSelector(".btn-primary")).click();
    driver.findElement(By.cssSelector(".alert")).click();
    assertThat(driver.findElement(By.cssSelector("strong")).getText(), is("Descrição inválida!!!!"));
  }
}
