...
import java.net.URL;
public class LoginrealizandoSQLinjectionTest {
  ...
  @Test
  public void loginrealizandoSQLinjection() {
    driver.get("http://localhost:8080/login");
    driver.manage().window().setSize(new Dimension(1440, 860));
    driver.findElement(By.id("username")).click();
    driver.findElement(By.id("username")).sendKeys("\'111\" or 2=2\"");
    driver.findElement(By.id("password")).click();
    driver.findElement(By.id("password")).sendKeys("\'123\" or \"2=2\"");
