...
import java.net.URL;
public class CriartarefavlidaTest {
  ...
  public void criartarefavlida() {
    ...
    driver.findElement(By.id("cpNome")).sendKeys("trabalhar");
    driver.findElement(By.id("cpData")).click();
    driver.findElement(By.id("cpData")).sendKeys("2024-10-31");
    ...
    assertThat(driver.findElement(By.cssSelector("tr:nth-child(2) > td:nth-child(1)")).getText(), is("trabalhar"));
  }
}
