...
import java.net.URL;
public class FinalizartarefaematrasoTest {
  ...
  @Test
  public void finalizartarefaematraso() {
    ...
    driver.findElement(By.cssSelector("tr:nth-child(7) .badge")).click();
    assertThat(driver.findElement(By.cssSelector("tr:nth-child(7) .badge")).getText(), is("concluída com atraso"));
  }
}
