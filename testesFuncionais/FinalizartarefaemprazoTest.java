...
import java.net.URL;
public class FinalizartarefaemprazoTest {
  ...
  @Test
  public void finalizartarefaemprazo() {
    ...
    driver.findElement(By.cssSelector("tr:nth-child(5) > td:nth-child(4)")).click();
    assertThat(driver.findElement(By.cssSelector("tr:nth-child(5) .badge")).getText(), is("concluída no prazo"));
  }
}
